...
struct TCDrawbackProcessRecord {
    ...
    15: optional string pay_account,
    16: optional string image_hash,
    17: optional i32 process_user_id,
    18: optional Timestamp processing_at,
}
...
service ElemeUserService {
    ...
    void exchange_gift_wkf(1:i32 user_id,
                       2:i32 gift_id,
                       3:string delivery_name,
                       4:string delivery_address,
                       5:string delivery_phone,
    ...
    void analyse_user_gift_wkf(1:i32 user_gift_id)
        throws (1: EUSUserException user_exception,
                2: EUSSystemException system_exception,
                3: EUSUnknownException unknown_exception),

    void human_check_pass_wkf(1:i64 user_gift_id)
        throws (1: EUSUserException user_exception,
                2: EUSSystemException system_exception,
                3: EUSUnknownException unknown_exception),

    void human_check_fail_wkf(1:i64 user_gift_id)
        throws (1: EUSUserException user_exception,
                2: EUSSystemException system_exception,
                3: EUSUnknownException unknown_exception),

    void gift_received_wkf(1:i64 user_gift_id)
        throws (1: EUSUserException user_exception,
                2: EUSSystemException system_exception,
                3: EUSUnknownException unknown_exception),
    ...
    void change_sns_hongbao_phone(1: string sns_uid,
                                  2: Mobile phone,
                                  3: SNSType sns_type)
        throws (1: EUSUserException user_exception,
                2: EUSSystemException system_exception,
