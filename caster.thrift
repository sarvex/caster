...
enum ERSErrorCode {
    ...
    // User Errors
    ACTIVITY_NOT_FOUND,
    ANONYMOUS_USER_PERMISSION_DENIED,
    APP_URL_NOT_FOUND,
    AREA_NOT_FOUND,
    BANKCARD_NOT_FOUND,
    BANKCARD_NOT_MATCH_CORPORATION,
    BANKCARD_WITH_NO_SUBSIDY,
    CITY_NOT_FOUND,
    COMMENT_NOT_FOUND,
    COMMENT_REPLY_NOT_FOUND,
    COUPON_ALREADY_USED, #deprecated
    COUPON_NOT_FOUND, #deprecated
    COUPON_OUT_OF_DATE, #deprecated
    ...
    FOOD_ACTIVITY_CANT_CHANGE_CITY,
    FOOD_ACTIVITY_CANT_CHANGE_DISCOUNT,
    FOOD_ACTIVITY_HAS_NO_LIMIT,
    FOOD_ACTIVITY_SUBSIDY_CANT_PROCESS,
    FOOD_ACTIVITY_SUBSIDY_NOT_FOUND,
    FOOD_ACTIVITY_FIELD_INVALID,
    FOOD_ACTIVITY_EFFECT_INVALID,
    FOOD_CATEGORY_POSITION_INVALID,
    FOOD_CATEGORY_NOT_COMPLETE,
    ...
    FOOD_CATEGORY_NOT_BELONGS_TO_RESTAURANT,
    FOOD_REQUIRED_GARNISH_CONFLICT,
    FOOD_UGC_IMAGE_LIKE_TOO_FREQUENTLY,
    FOOD_UGC_IMAGE_NOT_FOUND,
    FOOD_UGC_IMAGE_PR_NOT_FOUND,
    FOOD_POSITION_INVALID,
    FOOD_NOT_COMPLETE,
    ...
    SAAS_CONTRACT_PLAN_TYPE_ERROR,
    SAAS_CONTRACT_RANKING_INFO_MISSING,
    SAAS_CONTRACT_RANKING_INFO_ALREADY_SET,
    ...
    TOO_MANY_POLYGON_IN_DELIVER_AREA,
    DUPLICATED_POLYGON_IN_DELIVER_AREA,
    ORDER_IN_PENDING,
    TOO_MANY_POLYGON_IN_DELIVER_GEOJSON,
    RESTAURANT_POLYGON_AREA_TOO_LARGE,
    INVALID_RESTAURANT_GEOMETRY,
    MISS_PROPERTY_IN_DELIVER_GEOJSON,
    DUPLICATED_POLYGON_IN_DELIVER_GEOJSON,
    RESTAURANT_COMMENT_NOT_FOUND,
    INVALID_STOCK,
    FOOD_GARNISH_CATEGORY_NOT_FOUND,
    ACTIVITY_ICON_NOT_FOUND,
    FREE_GIFT_ACTIVITY_NOT_FOUND,
    ORDER_MODE_CORP_TYPE_NOT_MATCH,
    RESTAURANT_ACTIVITY_NOT_FOUND,
    RESTAURANT_ACTIVITY_FIELD_ERROR,
    CERTIFICATION_NOT_FOUND,
    CERTIFICATION_HAS_EXISTED,
    CERTIFICATION_UPDATE_DENIED,
    CERTIFICATION_PROCESS_ILLEGAL,
    INVALID_REGION_AREA,
    INVALID_RESTAURANT_ATTRIBUTE,
    DELIVERY_PRICE_MUST_BE_FIGURE,
    INVALUD_FOOD_DISCOUNT,
    ACTIVITY_CONTRACT_NOT_SIGNED,
    AMENDED_POI_NOT_FOUND,
    RESTAURANT_HAS_TOO_MANY_FOODS,
    VALIDATION_ERROR,
    VALIDATION_NONEXIST_ERROR,
...
enum EUSErrorCode {
    ...
    DOP_USER_NOT_FOUND,
    DRAWBACK_RECORD_NOT_FOUND,
    DRAWBACK_PROCESS_RECORD_NOT_FOUND,
    DRAWBACK_PROCESS_BATCH_NOT_FOUND,
    DUPLICATED_BANKCARD,
    DUPLICATED_BIND_CARD_REQUEST,
    DUPLICATED_DRAWBACK_ANONYMOUS_ORDER,
    EMAIL_OCCUPIED,
    ...
    HONGBAO_USED,
    HONGBAO_USE_LIMIT_EXCEED,
    HONGBAO_MOBILE_NOT_MATCH,
    HONGBAO_GROUP_NOT_FOUND,
    INSUFFICIENT_BALANCE,
    INVALID_BANKCARD_ID,
    INVALID_EMAIL,
    INVALID_BACKUP_PHONE,
    INVALID_HONGBAO_EXCHANGER,
    INVALID_EXCHANGE_FREQUENCY,
    INVALID_MOBILE,
    INVALID_PASSWORD,
    INVALID_PAY_COME_FROM,
    INVALID_PAY_COMPANY_ID,
    ...
    PAY_FOR_ORDER_TIMEOUT,
    PAY_RECORD_MAKE_TOO_FREQUENTLY,
    ...
    WEIXIN_USER_MAP_NOT_FOUND,
    WITHDRAW_RECORD_NOT_FOUND,
    WITHDRAW_RECORD_CANT_SUBMIT,
    WITHDRAW_RECORD_ALREADY_SUBMITTED,
    ...
    NOT_TESTER_USER,
    MENU_NOT_FOUND,
    USER_AUTH_OLD_PASSWORD_ERROR,
    USER_NOT_AUTOGENERATED,
    VALIDATION_ERROR,
    VALIDATION_NONEXIST_ERROR,
