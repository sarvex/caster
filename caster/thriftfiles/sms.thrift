...
service ShortMessageService {
    ...
    void hermes_reply_push(1: Mobile mobile,
                           2: string content,
    ...
    void hermes_report_push(1: Mobile mobile,
                            2: bool status,
                            3: i64 task_id,
    ...
    string hermes_send_verify_code(1: string sender_key,
                                   2: Mobile mobile,
                                   3: bool via_audio)
        throws (1: SMSUserException user_exception,
                2: SMSSystemException system_exception,
    ...
    bool hermes_validate_verify_code_with_hash(1: string sender_key,
                                               2: string hash_value,
                                               3: string code)
        throws (1: SMSUserException user_exception,
                2: SMSSystemException system_exception,
    ...
    bool hermes_validate_verify_code_with_receiver(1: string sender_key,
                                                   2: string receiver,
                                                   3: string code)
        throws (1: SMSUserException user_exception,
                2: SMSSystemException system_exception,
